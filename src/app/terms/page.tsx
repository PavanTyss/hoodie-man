    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
        ...
        <section className="mb-8">
          ...
          <p>
            By accessing and using Hoodie Man ("we," "our," or "us"), you accept and agree to be bound by these 
        ...
        <section className="mb-8">
          ...
          <p className="mt-4">
            Prices are in USD and do not include applicable taxes or shipping fees, which will be added at checkout.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            By placing an order, you make an offer to purchase products. We reserve the right to accept or decline 
            your order. Payment is processed securely through Stripe. You agree to provide valid payment information 
            and authorize us to charge your payment method for all purchases.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            We ship to addresses within the United States and internationally. Delivery times are estimates and not guaranteed.
          </p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Please see our <a href="/returns" className="text-blue-600 hover:underline">Return Policy</a> for detailed information. 
            In summary:
          </p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p>
            All content on this website, including text, graphics, logos, images, and software, is owned by Hoodie Man 
            or its licensors and protected by copyright and trademark laws. You may not reproduce, distribute, or 
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            By submitting reviews, photos, or other content, you grant us a non-exclusive, royalty-free, perpetual, 
            worldwide license to use, reproduce, and display such content. You represent that:
          </p>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="mb-8">
          ...
          <p>
            OUR WEBSITE AND PRODUCTS ARE PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. 
            WE DO NOT WARRANT THAT THE WEBSITE WILL BE UNINTERRUPTED, ERROR-FREE, OR SECURE. WE DISCLAIM ALL 
        ...
        <section className="mb-8">
          ...
          <p>
            TO THE FULLEST EXTENT PERMITTED BY LAW, HOODIE MAN SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, 
        ...
        <section className="mb-8">
          ...
          <p>
            You agree to indemnify and hold harmless Hoodie Man from any claims, damages, or expenses arising from 
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            provisions. Any disputes shall be resolved in the courts of New York County, New York.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-none space-y-2">
            <li><strong>Email:</strong> legal@hoodieman.com</li>
            <li><strong>Address:</strong> 123 Fashion Street, New York, NY 10001</li>
