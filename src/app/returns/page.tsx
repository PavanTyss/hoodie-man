    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
        ...
        <section className="mb-8">
          ...
          <p>
            You have <strong>30 days</strong> from the date of delivery to return most items for a full refund 
            or exchange. After 30 days, we cannot offer refunds or exchanges.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Unworn and Unwashed:</strong> Items must not have been worn or washed</li>
            <li><strong>Original Condition:</strong> In the same condition as received</li>
            <li><strong>Tags Attached:</strong> All original tags must still be attached</li>
            <li><strong>Original Packaging:</strong> Returned in original packaging when possible</li>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-4">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Step 1: Request a Return</h3>
            ...
            <p className="mt-2 text-sm text-gray-600">Include your order number and reason for return</p>
          </div>

          <div className="bg-gray-50 p-6 rounded-lg mb-4">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Step 2: Receive Return Authorization</h3>
            <p>
              We'll send you a Return Authorization (RA) number and return shipping label within 24 hours. 
              Please do not ship items without an RA number.
            </p>
          </div>

          <div className="bg-gray-50 p-6 rounded-lg mb-4">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Step 3: Pack Your Return</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Step 4: Ship Your Return</h3>
            <p>
              Drop off your package at any authorized carrier location. Keep your tracking number for your records.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Change of Mind:</strong> Customer responsible for return shipping ($7.95 deducted from refund)</li>
            <li><strong>Free Returns:</strong> Available on orders over $100</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p>
                Once we receive your return, we'll inspect it and process your refund within <strong>5-10 business days</strong>.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Partial Refunds</h3>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Size/color exchanges subject to $7.95 shipping fee</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Wrong Item Received</h2>
          <p>
            If we sent you the wrong item, we'll make it right! Contact us and we'll send the correct item 
            at no additional charge and provide a prepaid return label for the wrong item.
          </p>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Sale and Clearance Items</h2>
          <p>
            Items purchased during sales or from our clearance section can be returned within 30 days unless 
            marked as "Final Sale." All eligibility requirements still apply.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Gift Returns</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <ul className="list-none space-y-2">
            <li><strong>Email:</strong> returns@hoodieman.com</li>
        ...
        <div className="bg-green-50 border-l-4 border-green-600 p-6 mt-8">
          ...
          <p className="text-gray-700">
            Your satisfaction is our priority. If you have any issues with your order, please reach out to us. 
